...
import fondoCredito from '../assets/fondoCredito.jpg';
	...
	return (
		...
		>
			...
			>
				...
				>
					<Grid container rowSpacing={1} columns={{ xs: 6, md: 12 }}>
						<Grid
							item
							xs={6}
							sx={{
						...
						>
							...
							<CardContent>
								...
								>
									Facilidades de pago, descuentos del 3% por pago a contado,
									pago en efectivo.
								</Typography>
							</CardContent>
						</Grid>
						...
						>
							...
							<CardContent>
								...
								>
									Creditos directamente con la constructora sin necesidad de
									bancos, cuotas hasta de 5 años.
								</Typography>
							</CardContent>
						</Grid>
					</Grid>
